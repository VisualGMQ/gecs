...
constexpr auto to_gaming_state = +[](const SDL_KeyboardEvent& keyboard, gecs::commands cmds, gecs::querier<WelcomeEnt> querier) {
...
void OnEnterWelcome(gecs::commands cmds, gecs::resource<TextureManager> img_mgr, gecs::event_dispatcher<SDL_KeyboardEvent> keyboard) {
    ...
    cmds.emplace<WelcomeEnt>(how_to_play_ent);
