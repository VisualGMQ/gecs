...
struct event_dispatcher_sink final {
    using basic_event_dispatcher_type = ::gecs::basic_event_dispatcher<T, WorldT>;
    using sigh_type = typename basic_event_dispatcher_type::dispatcher_type::sigh_type;
    ...
    void add() noexcept {
        ...
        constexpr void(*f)(const T&, WorldT&)  = internal::system_constructor_v<Func, WorldT, const T&>;
